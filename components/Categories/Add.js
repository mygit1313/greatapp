...
import { addCategory } from '@/redux/action/admin/categories';
import { useDispatch } from 'react-redux';
import MaxLimit from '@/components/MaxLimit/Index';
export default function EditUserDrawer(props) {
    const { updateApiCalled, toggleDrawer, open } = props;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            var apiResponse = await dispatch(addCategory(values));
                                        ...
                                        <form className="grid grid-cols-1 gap" onSubmit={handleSubmit}>
                                            ...
                                            <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                                                <div className="flex items-start justify-between">
                                                    <Dialog.Title className="text-lg font-medium text-gray-900">Add</Dialog.Title>
                                                    ...
                                                    <div className="flow-root">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => {
                                                                ...
                                                                setValues({ ...values, tag_color: e.target.value })
                                                            }}
                                                        />
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => {
                                                                console.log(e.target.value)
                                                                setValues({ ...values, tag_text_color: e.target.value })
                                                            }}
                                                        />
